<div class="w-2/12 bg-gray-800  p-3 shadow-lg">
    ...
    <ul class="space-y-2 text-sm">
        ...
        <li>
            <a href="/login" class="flex items-center space-x-3 text-white p-2 rounded-md font-medium hover:bg-gray-600 focus:bg-gray-600 focus:shadow-outline">
                <span class="text-gray-200">
                    <svg class="h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                    </svg>
        ...
        <li>
            <a href="/logout" class="flex items-center space-x-3 text-white p-2 rounded-md font-medium hover:bg-gray-600 focus:bg-gray-600 focus:shadow-outline">
                <span class="text-gray-200">
                    <svg class="h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                    </svg>
